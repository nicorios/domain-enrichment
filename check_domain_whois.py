...
# Load CSV file
df = pd.read_csv("second_pass/df_8.csv")  # Replace with your actual file
...
# Save to CSV
df.to_csv("second_pass/df_8_enriched.csv", index=False)
print("WHOIS data collection completed and saved to df8.csv")
