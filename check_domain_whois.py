...
# Load CSV file
df = pd.read_csv("second_pass/df_9.csv")  # Replace with your actual file
...
# Save to CSV
df.to_csv("second_pass/df_9_enriched.csv", index=False)
print("WHOIS data collection completed and saved to df9.csv")
